package test.itschool.samsung.unichesss.engine.classic.player;

import test.itschool.samsung.unichesss.engine.classic.Alliance;
import test.itschool.samsung.unichesss.engine.classic.board.Board;
import test.itschool.samsung.unichesss.engine.classic.board.BoardUtils;
import test.itschool.samsung.unichesss.engine.classic.board.Move;
import test.itschool.samsung.unichesss.engine.classic.board.Move.KingSideCastleMove;
import test.itschool.samsung.unichesss.engine.classic.board.Move.QueenSideCastleMove;
import test.itschool.samsung.unichesss.engine.classic.pieces.Piece;
import test.itschool.samsung.unichesss.engine.classic.pieces.Rook;
...
import static test.itschool.samsung.unichesss.engine.classic.pieces.Piece.PieceType.ROOK;
